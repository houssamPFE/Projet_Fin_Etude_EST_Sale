...
use App\Http\Controllers\Api\V1\Conversation\ConversationDeleteController;
...
Route::prefix('v1')->group(function () {
    ...
    Route::prefix('conversations')->middleware('auth:sanctum')->group(function () {
        ...
        Route::patch('{conversation}', ConversationUpdateController::class);
        Route::delete('{conversation}', ConversationDeleteController::class);
